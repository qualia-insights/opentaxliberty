...
class Income(BaseModel):
    ...
    L1b: Decimal = Field(default=Decimal('0'), description="Household employee wages")
    L1c: Decimal = Field(default=Decimal('0'), description="Tip income")
    L1d: Decimal = Field(default=Decimal('0'), description="Medicaid waiver payments")
    L1e: Decimal = Field(default=Decimal('0'), description="Taxable dependent care benefits")
    L1f: Decimal = Field(default=Decimal('0'), description="Employer provided adoption benefits")
    L1g: Decimal = Field(default=Decimal('0'), description="Scholarship and fellowship grants")
    L1h: Decimal = Field(default=Decimal('0'), description="Pensions and annuities from Form 1099-R, Box 2a")
    L1i: Decimal = Field(default=Decimal('0'), description="Other earned income")
    L1z: Decimal = Field(Decimal('0'), description="List of fields to sum for line 1z")
    
    # Other income lines
    L2a: Decimal = Field(default=Decimal('0'), description="Tax-exempt interest")
    L2b: Decimal = Field(default=Decimal('0'), description="Taxable interest")
    L3a: Decimal = Field(default=Decimal('0'), description="Qualified dividends")
    L3b: Decimal = Field(default=Decimal('0'), description="Ordinary dividends")
    L4a: Decimal = Field(default=Decimal('0'), description="IRA distributions")
    L4b: Decimal = Field(default=Decimal('0'), description="Taxable IRA distributions")
    L5a: Decimal = Field(default=Decimal('0'), description="Pensions and annuities")
    L5b: Decimal = Field(default=Decimal('0'), description="Taxable pensions and annuities")
    L6a: Decimal = Field(default=Decimal('0'), description="Social security benefits")
    L6b: Decimal = Field(default=Decimal('0'), description="Taxable social security benefits")
    L6c: str = Field("/Off", description="Are you a retired public safety officer?")
    L7cb: str = Field("/Off", description="Capital gain or loss")
    L7: Decimal = Field(default=Decimal('0'), description="Capital gain or loss")
    L8: Decimal = Field(default=Decimal('0'), description="Other income")
    
    # Total income and adjusted gross income
    L9: Decimal = Field(default=Decimal('0'), description="Total income")
    L10: Decimal = Field(default=Decimal('0'), description="Adjustments to income")
    L11: Decimal = Field(default=Decimal('0'), description="Adjusted gross income")
    L12: Decimal = Field(default=Decimal('0'), description="Standard deduction or itemized deductions")
    L13: Decimal = Field(default=Decimal('0'), description="Qualified business income deduction")
    L14: Decimal = Field(default=Decimal('0'), description="Sum of standard deduction and QBI deduction")
    L15: Union[str, Decimal] = Field(default=Decimal('0'), description="Taxable income")
