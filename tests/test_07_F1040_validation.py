...
class TestF1040Validation:
    ...
    def test_invalid_tax_year(self, valid_f1040_data):
        ...
        valid_f1040_data["configuration"]["tax_year"] = 2030  # Future year
    ...
    def test_invalid_form_type(self, valid_f1040_data):
        ...
        valid_f1040_data["configuration"]["form"] = "1040"  # Missing 'F'
    ...
    def test_missing_required_field(self, valid_f1040_data):
        ...
        del valid_f1040_data["name_address_ssn"]["first_name_middle_initial"]
    ...
    def test_multiple_filing_statuses(self, valid_f1040_data):
        ...
        valid_f1040_data["filing_status"]["single_or_HOH"] = "/1"
        valid_f1040_data["filing_status"]["married_filing_jointly_or_QSS"] = "/3"
    ...
    def test_no_filing_status(self, valid_f1040_data):
        ...
        valid_f1040_data["filing_status"]["single_or_HOH"] = "/Off"
        valid_f1040_data["filing_status"]["married_filing_jointly_or_QSS"] = "/Off"
        valid_f1040_data["filing_status"]["married_filing_separately"] = "/Off"
    ...
    def test_invalid_checkbox_value(self, valid_f1040_data):
        ...
        valid_f1040_data["digital_assets"]["value"] = "YES"  # Invalid value, should be /1 or /2
    ...
    def test_invalid_payment_function(self, valid_f1040_data):
        ...
        valid_f1040_data["payments"]["L25a"] = "get_wrong_function()"  # Invalid function
    ...
    def test_both_refund_and_amount_owed(self, valid_f1040_data):
        ...
        valid_f1040_data["refund"]["L34_subtract"] = ["L33_sum", "L24_sum"]
        valid_f1040_data["amount_you_owe"]["L37"] = 500
    ...
    def test_direct_deposit_incomplete(self, valid_f1040_data):
        ...
        valid_f1040_data["refund"]["L35a_b"] = "123456789"  # Routing number
    ...
    def test_dependent_incomplete(self, valid_f1040_data):
        ...
        valid_f1040_data["dependents"]["dependent_1_ssn"] = None
    ...
    def test_no_refund_or_amount_owed(self, valid_f1040_data):
        ...
        valid_f1040_data.pop("refund", None)
        valid_f1040_data.pop("amount_you_owe", None)
    ...
    def test_w2_box_1_sum_function(self, valid_f1040_data):
        ...
        valid_f1040_data["income"]["L1a"] = "get_W2_box_1_sum()"
    ...
    def test_w2_box_2_sum_function(self, valid_f1040_data):
        ...
        # Explicitly set the function for testing
        valid_f1040_data["payments"]["L25a"] = "get_W2_box_2_sum()"
